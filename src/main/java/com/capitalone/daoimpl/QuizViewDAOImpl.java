...
public class QuizViewDAOImpl implements QuizViewDAO {
	...
	public List<Quiz> findAllQuizzes() {
		...
		String sqlStmt = "SELECT quiz.quiz_id, quiz.quiz_subject_area, quiz.quiz_description, quiz.quiz_creator_id, users.user_id,users.role_id "
				+ "FROM testyourknowledgelevel.quiz ,testyourknowledgelevel.users"
